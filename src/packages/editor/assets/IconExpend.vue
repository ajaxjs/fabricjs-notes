...
<template>
    <svg class="expend cursor-pointer" width='15' height='92' viewBox='0 0 15 92' fill='none'
        ...
        <path class="shape"
            ...
            :fill="expended ? 'var(--sidebar-accent)' : 'var(--sidebar)'" />
        <path
            ...
            :fill="expended ? '#FFF' : '#000'" fill-opacity='0.08' />
